...
image:https://circleci.com/gh/adarro/license-gradle-plugin-g8compat.svg?style=svg["CircleCI", link="https://circleci.com/gh/adarro/license-gradle-plugin-g8compat"]


This plugin is a minor fork of the excellent https://github.com/hierynomus/license-gradle-plugin[License Gradle Plugin] which addresses recent incompatibilities which Gradle 7+.

This repo will likely be archived once original is back on parity with current Gradle.
...
== Applying the plugin
If using Gradle < 7.0
Please use the https://github.com/hierynomus/license-gradle-plugin[original version.]

For gradle 7.x and above, this plugin should function as per the original using the id below.
Simply replace 'com.github.hierynomus.[plugin]' with 'io.truthencode.shadow.hierynomus.[plugin]'
...
----
plugins {
    id "io.truthencode.shadow.hierynomus.license" version "{license_plugin_version}"
}
----
...
- updated plugin id to io.truthencode.shadow to reflect shadowing.
- updated plugins  / dependencies with security warnings
* axion-release 1.11.0 -> 1.15.4
* plexus-utils 2.05 -> 3.0.16
* license-maven-plugin 3.0 - 4.1
* android build 4.1.0 -> 8.1.0
* guava 17.0 -> 30.0
- reduced visibility of resolveURI to protected
- Merged https://github.com/hierynomus/license-gradle-plugin/pull/210[#210] Configuration and Avoidance api
